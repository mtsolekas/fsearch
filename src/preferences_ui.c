...
preferences_ui_launch (FsearchConfig *config, GtkWindow *window)
{
    ...
    gtk_combo_box_set_active(GTK_COMBO_BOX (action_after_file_open),
    ...
    if (response == GTK_RESPONSE_OK) {
        ...
        main_config->action_after_file_open = gtk_combo_box_get_active(GTK_COMBO_BOX (action_after_file_open));
